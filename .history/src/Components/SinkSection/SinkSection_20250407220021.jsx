...
const SinkSection = () => {
  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 py-4 sm:py-6 lg:py-8 bg-offwhite dark:bg-darkslate transition-colors duration-300">
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-center mb-2 sm:mb-3 lg:mb-4 font-poppins drop-shadow-lg bg-clip-text text-transparent bg-gradient-to-r from-teal to-gold animate-pulse">
