...
const NationalMarblePage = () => {
  ...
  return (
    ...
    <h2 className="text-2xl sm:text-4xl font-extrabold text-teal dark:text-teal text-center mb-1 sm:mb-2 lg:mb-3 font-poppins drop-shadow-lg bg-clip-text text-transparent bg-gradient-to-r from-teal to-gold">
      الرخام الوطني
    </h2>
    <p className="text-charcoal dark:text-lightgray text-center mb-2 sm:mb-3 lg:mb-4 text-sm sm:text-base font-semibold">
