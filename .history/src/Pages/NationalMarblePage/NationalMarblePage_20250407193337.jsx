...
const NationalMarblePage = () => {
  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 pt-1 sm:pt-2 lg:pt-3 pb-2 sm:pb-3 lg:pb-4 bg-offwhite dark:bg-darkslate transition-colors duration-300">
      <h1 className="text-3xl sm:text-4xl font-extrabold text-teal dark:text-teal text-center mb-0.5 sm:mb-1 lg:mb-1.5 font-poppins drop-shadow-md">
        الرخام الوطني
      </h1>
      <p className="text-charcoal dark:text-lightgray text-center mb-0.5 sm:mb-1 lg:mb-1.5 text-sm sm:text-base">
