  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 pt-8 sm:pt-12 pb-16 sm:pb-24 bg-offwhite dark:bg-darkslate">
      ...
      <div className="text-center mb-12 sm:mb-16">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-teal dark:text-lightgray mb-6 font-tajawal tracking-tight">
          <span className="relative inline-block">
            الرخام الوطني السوري
            <span className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-teal to-gold dark:to-lightgray transform translate-y-1 rounded-full"></span>
          </span>
        </h1>
